...
>
  <title id="titleId">vanmanhgaming's GitHub Stats, Rank: SSS</title>
  <desc id="descId">Total Stars Earned: 1, Total Commits in 2025: 46, Total PRs: 0, Total Issues: 4, Contributed to (last year): 1</desc>
  <style>
    .header {
  ...
  >
    <g transform="translate(0, 0)">
      <text
        ...
        class="header"
        data-testid="header"
      >vanmanhgaming's GitHub Stats</text>
    </g>
  </g>
    ...
    <svg x="0" y="0">
      ...
      <g transform="translate(0, 25)">
        <g class="stagger" style="animation-delay: 600ms" transform="translate(25, 0)">
          ...
          <text class="stat bold" x="219.01" y="12.5" data-testid="commits">46</text>
        </g>
      </g>
